  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https:/wastewave-backend.onrender.com/api/company/signin",
        payload
      );
      ...
      const companyName = decodedToken.companyName; // Retrieve first name if available

      console.log(decodedToken);
      
      console.log("User ID:", userId);
      console.log("First Name:", companyName);
      // const userId = response.data.data._id;
      
      navigate(`/company/home/${userId}`, { state: { companyName } });
